    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!--<input type="button" value="Print This Report" style="font-weight: bold; background: #0fab8e; color: #fff; padding: 5px 15px; margin-bottom: 50px; float: right; border: none; border-radius: 15px;" onclick="javascript:printDiv('mydiv')" />-->
                      ...
                      A New Record Saved Successfully.
                            ...
                            <div class="table-responsive">
                                ...
                                <div>
                                    <form method="POST" action="server.php">
                                        ...
                                        <?php
                                            ...
                                            ";
                                        ?>
                                        <BR><button type="submit" class="btn btn-primary" name="editAskAI">Save Changes</button>
                                    </form>
                                </div>
                                ...
                                if ($row['status'] == 0) {
                                    ...
                                    echo "<a href='server.php?submitToTech=" . $row['code'] . "'><button type='button' class='btn btn-outline-primary'>Submit for Technician Review</button></a>&nbsp;&nbsp;";
                                    echo "<a href='server.php?closeCase=" . $row['code'] . "'><button type='button' class='btn btn-outline-danger'>Close</button></a>";
                                }
                                ?>
            ...
            <div class="py-6 px-6 text-center">
                <p class="mb-0 fs-4">Designed and Developed by Angel</p>
            </div>
        </div>
    </div>
    </div>
