        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
              <button type="button" style="float: right; position: relative; top: -10px;" onclick="window.location='add-job-request';" class="btn btn-outline-dark m-1">Add New Record</button>
              <h5 class="card-title fw-semibold mb-4">Recent Job Requets</h5>
              <?php
              ...
              <div class="table-responsive">
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM jobs ORDER BY id DESC");
                    $rowCount = 0;
