                      ...
                      A New Record Saved Successfully.
                            ...
                            <div class="table-responsive">
                                ...
                                <div>
                                    ...
                                    <?php
                                    echo "<p class='mb-0 fw-normal'>" . $row['info'] . " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='edit-ask-ai?code=".$_GET['code']."'><i class='ti ti-pencil'></i> Edit</a> </p>";
                                    ?>
                                </div>
                                ...
                                if ($row['status'] == 0) {
                                    ...
                                    echo "<a href='server.php?confirmSubmitToTech=" . $row['code'] . "'><button type='button' class='btn btn-outline-primary'>Submit for Technician Review</button></a>&nbsp;&nbsp;";
