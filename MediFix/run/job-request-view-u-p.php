                      ...
                      A New Record Saved Successfully.
                            ...
                            <div class="table-responsive">
                                ...
                                <div>
                                    ...
                                    <?php
                                    echo "<p class='mb-0 fw-normal'>" . $row['info'] . " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='edit-ask-ai-tech?code=".$_GET['code']."'><i class='ti ti-pencil'></i> Edit</a> </p>";
                                    ?>
                                </div>
                                ...
                                <?php
                                if ($row['status'] == 1 and $row['tech'] == null) {
                                    echo "<a href='ask-ai-tech?code=".$row['code']."'><button type='button' class='btn btn-outline-success'>Ask AI</button></a>&nbsp;&nbsp;";
                                    echo "<a href='add-tech-note?code=" . $row['code'] . "'><button type='button' class='btn btn-outline-primary'>Add Technician Review</button></a>&nbsp;&nbsp;";
                                }
                                if ($row['status'] != 2 and $row['tech'] != null) {
                                    echo "<a href='server.php?closeCaseTech=" . $row['code'] . "'><button type='button' class='btn btn-outline-danger'>Close</button></a>";
                                }
                                ?>
