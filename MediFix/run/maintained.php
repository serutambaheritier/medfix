        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
              <h5 class="card-title fw-semibold mb-4">Maintained Material / Equipment Requests</h5>
              <?php
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    ...
                    $doctor_id = $_SESSION['hbUser_Doctor'];
                                        $query = mysqli_query($connect, "SELECT * FROM jobs WHERE status = 2 AND givenby = '$doctor_id' ORDER BY id DESC");
                    $rowCount = 0;
