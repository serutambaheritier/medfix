              ...
              <div class="table-responsive">
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    ...
                    $tech_id = $_SESSION['hbUser_Tech'];
                    $query = mysqli_query($connect, "SELECT * FROM jobs WHERE status = 1 AND tech = '$tech_id' ORDER BY id DESC");
                    $rowCount = 0;
                    while ($row = mysqli_fetch_array($query)) {
                      ...
                      echo "<tr>
                          ...
                          echo"</td>
                          <td>
                            <a href='job-request-view-u-p?code=".$row['code']."'><button type='button' class='btn btn-success'>View & Add Note</button></a>
                          </td>
                        </tr>";
                    }
