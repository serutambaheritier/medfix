          ...
          <div class="card w-100">
            ...
            ?>
              ...
              <div style="float: right; position: relative; top: -10px;">
                <button style="float: right" type="button" onclick="window.location='add-doctor';" class="btn btn-outline-dark m-1">Add New</button>
                <button style="float: right" type="button" onclick="window.location='doctors';" class="btn btn-outline-success m-1">Refresh</button>
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                      ...
                      echo "<tr>
                          ...
                          <td>
                            <a href='edit-doctor?id=".$row['id']."'><button type='button' class='btn btn-primary'>Edit</button></a>
                            <a href='server.php?deleteDoc=".$row['id']."'><button type='button' class='btn btn-danger'>Delete</button></a>
                          </td>
                        </tr>";
                    }
