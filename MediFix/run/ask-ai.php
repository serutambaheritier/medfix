                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            ...
                            <br>
                            <hr>
                            <p style='color: #c00;'><b>NOTE:</b> If none of the above helps, kindly reach out to the dedicated technician for further assistance.</p>

                            <br><br>
                            <br><br>
                            <div class="d-flex justify-content-between">
                                <a href='server.php?resolveJobAI=<?php echo $row['code']; ?>'>
                                    <button type='button' class='btn btn-success'>I fixed it! (Problem Resolved)</button>
                                </a>
                                <a href='server.php?confirmSubmitToTech=<?php echo $row['code']; ?>'>
                                    <button type='button' class='btn btn-primary'>Not solved. Submit to Technician</button>
                                </a>
                            </div>
                        </div>
                    </div>
