        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
              <h5 class="card-title fw-semibold mb-4">Maintained Job Requets</h5>
              <?php
              ...
              <div class="table-responsive">
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM jobs WHERE status = 2 AND tech IS NOT NULL ORDER BY id DESC");
                    $rowCount = 0;
                    while ($row = mysqli_fetch_array($query)) {
                      ...
                      echo "<tr>
                          ...
                          echo"</td>
                          <td>
                            <a href='job-request-view-u-p?code=".$row['code']."'><button type='button' class='btn btn-success'>View</button></a>
                          </td>
                        </tr>";
                    }
